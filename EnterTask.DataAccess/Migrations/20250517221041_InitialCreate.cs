        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_Event_MaxPeopleCount_Positive", "[MaxPeopleCount] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventChange", x => x.Id);
                    table.ForeignKey(
                        name: "fk_EventChange_Event_Id",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Registration", x => new { x.ParticipantId, x.EventId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_Registration_Participant_Id",
                        column: x => x.ParticipantId,
                        principalTable: "Participant",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventChange_EventId",
                table: "EventChange",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_EventImage_EventId_Number",
                table: "EventImage",
